...
class Head(Component):
    ...
    def __init__(
        ...
        author: Any = None,
        robots: Any = None,  # "index, follow", "noindex, nofollow", etc.
        canonical: Any = None,
        # Favicon (per-page override)
        favicon: Any = None,
        # Open Graph (Facebook, LinkedIn, etc.)
        og_title: Any = None,
        og_description: Any = None,
        og_image: Any = None,
        og_image_width: Optional[int] = None,
        og_image_height: Optional[int] = None,
        og_type: Any = "website",  # article, product, etc.
        og_url: Any = None,
        og_site_name: Any = None,
        og_locale: Any = None,
        # Twitter Card
        twitter_card: Any = "summary",  # summary, summary_large_image, app, player
        twitter_site: Any = None,  # @username
        twitter_creator: Any = None,  # @username
        twitter_title: Any = None,
        twitter_description: Any = None,
        twitter_image: Any = None,
        # Custom meta tags
