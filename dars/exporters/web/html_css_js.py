...
"""
    ...
    def render_markdown(self, markdown: 'Markdown') -> str:
        ...
        if cfg_hl and current_page_id not in self._hljs_injected_pages:
            ...
            parts.append('<script src="https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/plugins/autoloader/prism-autoloader.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>\n')
