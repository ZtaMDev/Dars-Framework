...
if(typeof window!=="undefined"&&Array.isArray(window.__DARS_STATE__)){if(window.Dars&&window.Dars.registerStates){window.Dars.registerStates(window.__DARS_STATE__);}else{import("./dars.min.js").then(m=>{const reg=m.registerStates||(m.default&&m.default.registerStates);if(typeof reg==="function")reg(window.__DARS_STATE__);}).catch(()=>{});}}
if(typeof window!=="undefined"&&Array.isArray(window.__DARS_STATE_V2__)){if(window.Dars&&window.Dars.registerStates){window.Dars.registerStates(window.__DARS_STATE_V2__);}else{import("./dars.min.js").then(m=>{const reg=m.registerStates||(m.default&&m.default.registerStates);if(typeof reg==="function")reg(window.__DARS_STATE_V2__);}).catch(()=>{});}}}catch(err){console.error("[Dars:Debug] Critical error during hydration block:",err);}