(()=>{var c=Object.create;var s=Object.defineProperty;var l=Object.getOwnPropertyDescriptor;var m=Object.getOwnPropertyNames;var u=Object.getPrototypeOf,p=Object.prototype.hasOwnProperty;var f=(t,n,r,e)=>{if(n&&typeof n=="object"||typeof n=="function")for(let i of m(n))!p.call(t,i)&&i!==r&&s(t,i,{get:()=>n[i],enumerable:!(e=l(n,i))||e.enumerable});return t};var d=(t,n,r)=>(r=t!=null?c(u(t)):{},f(n||!t||!t.__esModule?s(r,"default",{value:t,enumerable:!0}):r,t));(function(){function t(){var e=document.getElementById("image_0_0_0_0_0");e&&e.addEventListener("click",async function(o){if(!window.Dars)try{const a=await import("./lib/dars.min.js");window.Dars=a.default||a}catch{}try{window.location.href="https://ztamdev.github.io/Dars-Framework/"}catch(a){console.error("Error en handler:",a)}});var i=document.getElementById("text_0_0_0_0_1");i&&i.addEventListener("click",async function(o){if(!window.Dars)try{const a=await import("./lib/dars.min.js");window.Dars=a.default||a}catch{}try{window.location.href="https://ztamdev.github.io/Dars-Framework/"}catch(a){console.error("Error en handler:",a)}})}function n(){try{const e=[{name:"counter",id:"counter",defaultValue:{count:0},isV2:!0}];window.Dars&&typeof window.Dars.registerStates=="function"?window.Dars.registerStates(e):window.__DARS_STATES_FN?window.__DARS_STATES_FN(e):(async()=>{try{const i=await import("./lib/dars.min.js"),o=i.registerStates||i.default&&i.default.registerStates;typeof o=="function"&&(o(e),window.__DARS_STATES_FN=o)}catch(i){console.error("[Dars] Failed to initialize states",i)}})()}catch(e){console.error("[Dars] State initialization error",e)}}function r(){(async()=>{try{const e=await import("./lib/dap.js");e.__darsConfig&&(e.__darsConfig.allowInlineJS=!0)}catch{}})(),window.__DARS_SPA_CONFIG__?window.__DARS_SPA_CONFIG__.backendUrl||(window.__DARS_SPA_CONFIG__.backendUrl="/"):window.__DARS_SPA_CONFIG__={backendUrl:"/"},n(),t();try{window.Dars&&typeof window.Dars.addReactiveBinding=="function"?window.Dars.addReactiveBinding(function(e){if(e&&e.dynamic&&e.id&&e.id==="counter"){let i;if(e.attrs&&e.attrs.count!==void 0?i=e.attrs.count:e.count!==void 0&&(i=e.count),i!==void 0){const o=document.getElementById("demo-counter-value");o&&(o.hasAttribute("data-server-component")&&o.firstElementChild?o.firstElementChild.textContent=String(i):o.textContent=String(i),o.hasAttribute("data-server-component")&&o.firstElementChild?o.firstElementChild.textContent=String(i):o.textContent=String(i),o.hasAttribute("data-server-component")&&o.firstElementChild?o.firstElementChild.textContent=String(i):o.textContent=String(i),o.hasAttribute("data-server-component")&&o.firstElementChild?o.firstElementChild.textContent=String(i):o.textContent=String(i),o.hasAttribute("data-server-component")&&o.firstElementChild?o.firstElementChild.textContent=String(i):o.textContent=String(i),o.hasAttribute("data-server-component")&&o.firstElementChild?o.firstElementChild.textContent=String(i):o.textContent=String(i))}}}):console.warn("[Dars:Debug] window.Dars.addReactiveBinding NOT found. Skipping reactive bindings.")}catch(e){console.error("[Dars] Failed to initialize reactive bindings",e)}(async()=>{try{const e=await import("./lib/dap.js");e._initConditionalElements&&await e._initConditionalElements({})}catch{}})()}document.readyState==="complete"||document.readyState==="interactive"?r():document.addEventListener("DOMContentLoaded",r)})();window.addEventListener("scroll",()=>{const t=document.getElementById("dars-navbar");t&&(window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled"))});document.addEventListener("DOMContentLoaded",function(){const t=document.getElementById("hamburger-btn"),n=document.getElementById("mobile-menu"),r=document.body;t&&n&&(t.addEventListener("click",function(e){e.stopPropagation(),n.style.display==="flex"?(n.style.display="none",t.classList.remove("menu-open"),r.classList.remove("menu-open")):(n.style.display="flex",t.classList.add("menu-open"),r.classList.add("menu-open"))}),n.querySelectorAll("a").forEach(e=>{e.addEventListener("click",function(){n.style.display="none",t.classList.remove("menu-open"),r.classList.remove("menu-open")})}),document.addEventListener("click",function(e){!t.contains(e.target)&&!n.contains(e.target)&&(n.style.display="none",t.classList.remove("menu-open"),r.classList.remove("menu-open"))}),document.addEventListener("keydown",function(e){e.key==="Escape"&&n.style.display==="flex"&&(n.style.display="none",t.classList.remove("menu-open"),r.classList.remove("menu-open"))}))});(function(){var t=document.getElementById("markdown-content-container");if(t){var n=document.createElement("style");n.textContent=`
