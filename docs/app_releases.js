...
In the github repository [Here](https://github.com/ZtaMDev/Dars-Framework/releases).`}]},{type:"T2",id:"footer-section",children:[{type:"T2",id:"container_172",children:[{type:"T2",id:"container_173",children:[{type:"T2",id:"container_174",children:[{type:"T4",id:"image_175"},{type:"T2",id:"container_176",children:[{type:"T5",id:"text_177",text:"Dars Framework"}]}]},{type:"T2",id:"container_178",children:[{type:"T2",id:"container_179",children:[{type:"T5",id:"text_180",text:"Quick Links"},{type:"T6",id:"link_181",text:"Documentation"},{type:"T6",id:"link_182",text:"GitHub"},{type:"T6",id:"link_183",text:"Examples"}]},{type:"T2",id:"container_184",children:[{type:"T5",id:"text_185",text:"Resources"},{type:"T6",id:"link_186",text:"Getting Started"},{type:"T6",id:"link_187",text:"Releases"}]},{type:"T2",id:"container_188",children:[{type:"T5",id:"text_189",text:"Info: "},{type:"T5",id:"text_190",text:"A modern Python framework for web and desktop applications"}]}]},{type:"T2",id:"container_191",children:[{type:"T2",id:"container_192",children:[{type:"T5",id:"text_193",text:"\xA9 2024 Dars Framework."}]},{type:"T2",id:"container_194",children:[{type:"T5",id:"text_195",text:"Created with "},{type:"T6",id:"link_196",text:"Dars Framework"},{type:"T5",id:"text_197",text:" by "},{type:"T6",id:"link_198",text:"ZtaDev"}]}]}]}]}]}]},{type:"T10",id:"documentation-sidebar"}]},function(){const d=new Map;let r=null,l=null;function c(){}function v(){}function g(e,n){if(!e)return;n(e);const t=e.children||[];for(let i=0;i<t.length;i++)g(t[i],n)}function k(e){try{if(typeof atob=="function")return atob(e);if(typeof Buffer<"u")return Buffer.from(e,"base64").toString("utf8")}catch{}return""}function S(e){try{if(!e)return null;if(e&&e.type==="inline"&&e.code)return new Function("event",e.code);const n=e&&(e.b||e.code_b64)||null;if(n){const t=k(n);if(t)return new Function("event",t)}}catch{}return null}function A(e){g(e,n=>{if(n&&n.id&&n.events&&!d.has(n.id)){const t={};for(const i in n.events){const o=n.events[i],p=S(o);p&&(t[i]=p)}Object.keys(t).length?d.set(n.id,t):d.delete(n.id)}})}function N(e,n){if(!(!e||!n))for(const[t,i]of Object.entries(n))try{i===!1||i===null||typeof i>"u"?e.removeAttribute(t):e.setAttribute(t,String(i))}catch{}}function E(e,n={},t={}){for(const i in n)if(!(i in t))try{e.removeAttribute(i)}catch{}for(const i in t){const o=t[i];try{o===!1||o===null||typeof o>"u"?e.removeAttribute(i):e.setAttribute(i,String(o))}catch{}}}function M(e,n={},t={}){for(const i in n)if(!(i in t))try{e.style.removeProperty(i.replace(/_/g,"-"))}catch{}for(const i in t){const o=t[i];try{e.style.setProperty(i.replace(/_/g,"-"),String(o))}catch{}}}function C(e,n){(n||document).addEventListener(e,function(t){let i=t.target;const o=n||document;for(;i&&i!==o;){const p=i.id;if(p&&d.has(p)){const u=d.get(p)[e];if(i&&i.__darsEv&&i.__darsEv[e])return;if(typeof u=="function"){try{u.call(i,t)}catch(a){console.error("[Dars] handler error",a)}return}}i=i.parentNode}},!0)}function x(e,n){return e&&n?e.type!==n.type:e!==n}function _(e){if(!e)return;const n=e.children||[];for(let t=0;t<n.length;t++)_(n[t]);if(e.id&&d.delete(e.id),e.id){const t=document.getElementById(e.id);if(t&&t.parentNode)try{t.parentNode.removeChild(t)}catch{}}}function b(e,n){if(!n||!n.id)return{ok:!1,reason:"missing-new"};let t=document.getElementById(n.id);if(!t){const a=e&&e.id?document.getElementById(e.id):null;if(a)try{a.id=n.id,t=a}catch{}}if(!t)return{ok:!1,reason:"missing-el"};if(x(e,n))return{ok:!1,reason:"type-changed"};const i=!!n.isIsland;if(!i&&n.class&&(t.className=n.class),i||E(t,e&&e.props||{},n.props||{}),i||M(t,e&&e.style||{},n.style||{}),!i&&Object.prototype.hasOwnProperty.call(n,"text")&&t.textContent!==String(n.text||"")&&(t.textContent=String(n.text||"")),i)return{ok:!0};const o=e&&e.children?e.children:[],p=n.children?n.children:[],m=new Map;for(let a=0;a<o.length;a++){const s=o[a]&&(o[a].id||o[a].key)||null;s&&m.set(String(s),o[a])}const u=new Set;for(let a=0;a<p.length;a++){const s=p[a],T=s&&(s.id||s.key)||null;if(!T)if(a<o.length){const f=b(o[a],s);if(!f.ok)return f;u.add(o[a]);continue}else return{ok:!1,reason:"children-added"};const w=m.get(String(T));if(w){const f=b(w,s);if(!f.ok)return f;u.add(w)}else{if(a<o.length){const h=o[a];if(!x(h,s)){const y=b(h,s);if(!y.ok)return y;u.add(h);continue}}const f=createSubtree(s);if(f){const h=a<o.length?o[a]:null;if(h&&h.id){const y=document.getElementById(h.id);y&&y.parentNode?y.parentNode.insertBefore(f,y):t.appendChild(f)}else t.appendChild(f);continue}return{ok:!1,reason:"children-added"}}}for(let a=0;a<o.length;a++){const s=o[a];u.has(s)||_(s)}return{ok:!0}}function D(e){typeof requestAnimationFrame=="function"?requestAnimationFrame(e):setTimeout(e,16)}function L(e){const n=r;if(!n){r=e;try{window.__DARS_VDOM__=e}catch{}return}D(()=>{const t=b(n,e);if(!t.ok){console.warn("[Dars] Structural change detected (",t.reason,"), reloading...");try{location.reload()}catch{}return}r=e;try{window.__DARS_VDOM__=e}catch{}})}function I(e){r=e;try{window.__DARS_VDOM__=e}catch{}["click","dblclick","mousedown","mouseup","mouseenter","mouseleave","mousemove","keydown","keyup","keypress","change","input","submit","focus","blur"].forEach(t=>C(t,document))}function B(){const e=window.__DARS_VERSION_URL||"version.txt";let n=null,t=!1;function i(p,m,u,a){try{const s=new XMLHttpRequest;a&&(s.responseType=a),s.open("GET",p,!0),s.timeout=5e3,s.onreadystatechange=function(){s.readyState===4&&(s.status>=200&&s.status<300?m(s.response):u())},s.onerror=u,s.ontimeout=u,s.setRequestHeader("Cache-Control","no-store"),s.send()}catch{u()}}function o(){i(e,function(p){let m=(p||"").toString().trim();if(m&&(t=!1),l||(l=m),m&&m!==l){l=m;try{location.reload()}catch{}return}n=setTimeout(o,600)},function(){t||(console.log("[Dars] waiting for version.txt"),t=!0),n=setTimeout(o,600)},"text")}return o(),()=>{n&&clearTimeout(n)}}document.addEventListener("DOMContentLoaded",function(){window.__DARS_VDOM__?I(window.__DARS_VDOM__):console.warn("[Dars] No VDOM snapshot found for hydration"),window.__DARS_VERSION_URL&&window.__DARS_SNAPSHOT_URL&&B()})}(),window.addEventListener("scroll",()=>{const d=document.getElementById("dars-navbar");window.scrollY>20?d.classList.add("scrolled"):d.classList.remove("scrolled");const r=document.getElementById("features-section");if(r&&!r.classList.contains("visible")){const l=r.getBoundingClientRect().top,c=window.innerHeight/1.5;l<c&&(r.classList.add("visible"),document.querySelectorAll('[id^="feature-card-"]').forEach((g,k)=>{setTimeout(()=>{g.style.opacity="1",g.style.transform="translateY(0)"},k*100)}))}}),document.addEventListener("DOMContentLoaded",()=>{const d=document.getElementById("hero-logo"),r=document.getElementById("hero-title"),l=document.getElementById("hero-description"),c=document.getElementById("pip-command"),v=document.getElementById("get-started-btn"),g=document.getElementById("scroll-text");d&&setTimeout(()=>d.classList.add("show"),5),r&&setTimeout(()=>r.classList.add("show"),350),l&&setTimeout(()=>l.classList.add("show"),650),c&&setTimeout(()=>c.classList.add("show"),950),v&&setTimeout(()=>v.classList.add("show"),1250),g&&setTimeout(()=>g.classList.add("show"),1500)});function R(){window.open("https://ztamdev.github.io/Dars-Framework/docs.html","_self")}function P(){navigator.clipboard.writeText("pip install dars framework").then(()=>{const r=document.querySelector("#copy-btn"),l=r.textContent;r.textContent="Copied!",r.style.background="linear-gradient(135deg, #38c49f 0%, #2a6b5b 100%) !important",setTimeout(()=>{r.textContent=l,r.style.background="linear-gradient(135deg, #1d4a3f 0%, #2a6b5b 100%) !important"},2e3)})}document.addEventListener("DOMContentLoaded",function(){const d=document.getElementById("hamburger-btn"),r=document.getElementById("mobile-menu"),l=document.body;d&&r&&(d.addEventListener("click",function(c){c.stopPropagation(),r.style.display==="flex"?(r.style.display="none",d.classList.remove("menu-open"),l.classList.remove("menu-open")):(r.style.display="flex",d.classList.add("menu-open"),l.classList.add("menu-open"))}),r.querySelectorAll("a").forEach(c=>{c.addEventListener("click",function(){r.style.display="none",d.classList.remove("menu-open"),l.classList.remove("menu-open")})}),document.addEventListener("click",function(c){!d.contains(c.target)&&!r.contains(c.target)&&(r.style.display="none",d.classList.remove("menu-open"),l.classList.remove("menu-open"))}),document.addEventListener("keydown",function(c){c.key==="Escape"&&r.style.display==="flex"&&(r.style.display="none",d.classList.remove("menu-open"),l.classList.remove("menu-open"))}))});
