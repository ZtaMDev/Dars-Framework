(()=>{window.__DARS_VDOM__={type:"T1",id:"page_90",key:"0",children:[{type:"T2",id:"container_91",key:"0/0",children:[{type:"T3",id:"dars-navbar",key:"0/0/0",children:[{type:"T2",id:"navbar-left",key:"0/0/0/0",children:[{type:"T4",id:"image_92",key:"0/0/0/0/0"},{type:"T5",id:"text_93",key:"0/0/0/0/1",text:"Dars Framework"}]},{type:"T2",id:"container_94",key:"0/0/0/1",children:[{type:"T2",id:"navbar-right",key:"0/0/0/1/0",children:[{type:"T6",id:"link_95",key:"0/0/0/1/0/0",text:"Home"},{type:"T6",id:"link_96",key:"0/0/0/1/0/1",text:"Documentation"},{type:"T6",id:"link_97",key:"0/0/0/1/0/2",text:"Releases"},{type:"T6",id:"link_98",key:"0/0/0/1/0/3",text:"PlayGround"},{type:"T6",id:"link_99",key:"0/0/0/1/0/4",text:"GitHub"}]},{type:"T2",id:"hamburger-menu",key:"0/0/0/1/1",children:[{type:"T2",id:"hamburger-btn",key:"0/0/0/1/1/0",children:[{type:"T2",id:"container_100",key:"0/0/0/1/1/0/0",children:[{type:"T2",id:"container_101",key:"0/0/0/1/1/0/0/0"},{type:"T2",id:"container_102",key:"0/0/0/1/1/0/0/1"},{type:"T2",id:"container_103",key:"0/0/0/1/1/0/0/2"}]}]},{type:"T2",id:"mobile-menu",key:"0/0/0/1/1/1",children:[{type:"T6",id:"link_104",key:"0/0/0/1/1/1/0",text:"Home"},{type:"T6",id:"link_105",key:"0/0/0/1/1/1/1",text:"Documentation"},{type:"T6",id:"link_106",key:"0/0/0/1/1/1/2",text:"Releases"},{type:"T6",id:"link_107",key:"0/0/0/1/1/1/3",text:"PlayGround"},{type:"T6",id:"link_108",key:"0/0/0/1/1/1/4",text:"GitHub"}]}]}]}]}]},{type:"T8",id:"documentation-sidebar",key:"0/1"},{type:"T2",id:"markdown-layout",key:"0/2",children:[{type:"T2",id:"markdown-content-container",key:"0/2/0",children:[{type:"T9",id:"md-index",key:"0/2/0/0",text:`# Dars Framework Documentation (Dars is not longer maintained due to critical vulnerabilities in the core of the framework please leave dars and use the new alternative that is being developed called "Axiom" that will be more secure and modern)
...
- [CLI Usage and Commands](#dars-cli-reference)
`},{type:"T9",id:"md-install",key:"0/2/0/1",text:`# Installation Guide - Dars Framework
...
`},{type:"T9",id:"md-getting_started",key:"0/2/0/2",text:`# Getting Started with Dars
...
`},{type:"T9",id:"md-cli",key:"0/2/0/3",text:`# Dars CLI Reference
...
`},{type:"T9",id:"md-app",key:"0/2/0/6",text:`# App Class and PWA Features in Dars Framework
...
- Edge (full support)`},{type:"T9",id:"md-components",key:"0/2/0/7",text:`# Dars - Components Documentation
...
- Boolean props are wired to the same reactive mechanism que otros componentes built-in:
  - El runtime a\xF1ade/quita los atributos HTML y sincroniza las propiedades JS (\`el.loop\`, \`el.muted\`, etc.).
- Es recomendable ubicar los ficheros dentro de \`media/\` en el root del proyecto y referenciarlos como \`/media/...\`.
  El exporter copiar\xE1 autom\xE1ticamente esa carpeta al directorio de export.
...
---
`},{type:"T9",id:"md-animations",key:"0/2/0/10",text:`# Dars Animation System
...
\`\`\`
`},{type:"T9",id:"md-routing",key:"0/2/0/11",text:`# SPA Routing in Dars Framework
...
---
`},{type:"T9",id:"md-ssr",key:"0/2/0/12",text:`# Server-Side Rendering in Dars Framework
...
- Targeting the clicked element`},{type:"T9",id:"md-hooks",key:"0/2/0/14",text:`# Hooks System
...
---`},{type:"T9",id:"md-operations",key:"0/2/0/15",text:`# Operations in Dars
...
# Complex formula: (a\xB2 + b\xB2)^0.5 (Pythagorean theorem)
calc.hypotenuse.set(
...
---
`},{type:"T9",id:"md-backend_api",key:"0/2/0/16",text:`# Backend HTTP Utilities 
...
dars dev
\`\`\`
`},{type:"T9",id:"md-events",key:"0/2/0/17",text:`# Events in Dars
...
\`\`\`
`},{type:"T9",id:"md-KeyEvents",key:"0/2/0/18",text:`# Keyboard Events in Dars
...
`},{type:"T9",id:"md-exporters",key:"0/2/0/19",text:`# Dars - Exporter Documentation
...
`},{type:"T9",id:"md-scripts",key:"0/2/0/20",text:`# Dars - Script System
...
`}]},{type:"T2",id:"footer-section",key:"0/2/1",children:[{type:"T2",id:"container_109",key:"0/2/1/0",children:[{type:"T2",id:"container_110",key:"0/2/1/0/0",children:[{type:"T2",id:"container_111",key:"0/2/1/0/0/0",children:[{type:"T4",id:"image_112",key:"0/2/1/0/0/0/0"},{type:"T2",id:"container_113",key:"0/2/1/0/0/0/1",children:[{type:"T5",id:"text_114",key:"0/2/1/0/0/0/1/0",text:"Dars Framework"}]}]},{type:"T2",id:"container_115",key:"0/2/1/0/0/1",children:[{type:"T2",id:"container_116",key:"0/2/1/0/0/1/0",children:[{type:"T5",id:"text_117",key:"0/2/1/0/0/1/0/0",text:"Quick Links"},{type:"T6",id:"link_118",key:"0/2/1/0/0/1/0/1",text:"Documentation"},{type:"T6",id:"link_119",key:"0/2/1/0/0/1/0/2",text:"GitHub"},{type:"T6",id:"link_120",key:"0/2/1/0/0/1/0/3",text:"Examples"}]},{type:"T2",id:"container_121",key:"0/2/1/0/0/1/1",children:[{type:"T5",id:"text_122",key:"0/2/1/0/0/1/1/0",text:"Resources"},{type:"T6",id:"link_123",key:"0/2/1/0/0/1/1/1",text:"Getting Started"},{type:"T6",id:"link_124",key:"0/2/1/0/0/1/1/2",text:"Releases"}]},{type:"T2",id:"container_125",key:"0/2/1/0/0/1/2",children:[{type:"T5",id:"text_126",key:"0/2/1/0/0/1/2/0",text:"A modern FullStack Python framework for web and desktop applications."}]}]},{type:"T2",id:"container_127",key:"0/2/1/0/0/2",children:[{type:"T2",id:"container_128",key:"0/2/1/0/0/2/0",children:[{type:"T5",id:"text_129",key:"0/2/1/0/0/2/0/0",text:"\xA9 2025 Dars Framework."}]},{type:"T2",id:"container_130",key:"0/2/1/0/0/2/1",children:[{type:"T5",id:"text_131",key:"0/2/1/0/0/2/1/0",text:"Created with "},{type:"T6",id:"link_132",key:"0/2/1/0/0/2/1/1",text:"Dars Framework"},{type:"T5",id:"text_133",key:"0/2/1/0/0/2/1/2",text:" by "},{type:"T6",id:"link_134",key:"0/2/1/0/0/2/1/3",text:"ZtaDev"}]}]}]}]}]}]}]};(function(){const d=new Map;let l=null,p=null;function u(){}function v(){}function _(n,t){if(!n)return;t(n);const e=n.children||[];for(let o=0;o<e.length;o++)_(e[o],t)}function S(n,t){if(!(!n||!t))for(const[e,o]of Object.entries(t))try{o===!1||o===null||typeof o>"u"?n.removeAttribute(e):n.setAttribute(e,String(o))}catch{}}function D(n,t={},e={}){for(const o in t)if(!(o in e))try{n.removeAttribute(o)}catch{}for(const o in e){const i=e[o];try{i===!1||i===null||typeof i>"u"?n.removeAttribute(o):n.setAttribute(o,String(i))}catch{}}}function P(n,t={},e={}){for(const o in t)if(!(o in e))try{n.style.removeProperty(o.replace(/_/g,"-"))}catch{}for(const o in e){const i=e[o];try{n.style.setProperty(o.replace(/_/g,"-"),String(i))}catch{}}}function A(n,t){(t||document).addEventListener(n,function(e){let o=e.target;const i=t||document;for(;o&&o!==i;){const m=o.id;if(m&&d.has(m)){const y=d.get(m);if(o&&o.__darsEv&&o.__darsEv[n])return;let c=y[n];if(!c&&(n==="keydown"||n==="keyup"||n==="keypress")){const a=e.key||e.code;if(a){const r=n+"."+a;c=y[r]}}if(typeof c=="function"){try{c.call(o,e)}catch(a){console.error("[Dars] handler error",a)}return}}o=o.parentNode}},!0)}function w(n,t){return n&&t?n.type!==t.type:n!==t}function k(n){if(!n)return;const t=n.children||[];for(let e=0;e<t.length;e++)k(t[e]);if(n.id&&d.delete(n.id),n.id){const e=document.getElementById(n.id);if(e&&e.parentNode)try{e.parentNode.removeChild(e)}catch{}}}function x(n,t){if(!t||!t.id)return{ok:!1,reason:"missing-new"};let e=document.getElementById(t.id);if(!e){const a=n&&n.id?document.getElementById(n.id):null;if(a)try{a.id=t.id,e=a}catch{}}if(!e)return{ok:!1,reason:"missing-el"};if(w(n,t))return{ok:!1,reason:"type-changed"};const o=!!t.isIsland;if(!o&&t.class&&(e.className=t.class),o||D(e,n&&n.props||{},t.props||{}),o||P(e,n&&n.style||{},t.style||{}),!o&&Object.prototype.hasOwnProperty.call(t,"text")&&e.textContent!==String(t.text||"")&&(e.textContent=String(t.text||"")),o)return{ok:!0};const i=n&&n.children?n.children:[],m=t.children?t.children:[],y=new Map;for(let a=0;a<i.length;a++){const r=i[a]&&(i[a].id||i[a].key)||null;r&&y.set(String(r),i[a])}const c=new Set;for(let a=0;a<m.length;a++){const r=m[a],h=r&&(r.id||r.key)||null;if(!h)if(a<i.length){const s=x(i[a],r);if(!s.ok)return s;c.add(i[a]);continue}else return{ok:!1,reason:"children-added"};const b=y.get(String(h));if(b){const s=x(b,r);if(!s.ok)return s;c.add(b)}else{if(a<i.length){const f=i[a];if(!w(f,r)){const g=x(f,r);if(!g.ok)return g;c.add(f);continue}}const s=createSubtree(r);if(s){const f=a<i.length?i[a]:null;if(f&&f.id){const g=document.getElementById(f.id);g&&g.parentNode?g.parentNode.insertBefore(s,g):e.appendChild(s)}else e.appendChild(s);continue}return{ok:!1,reason:"children-added"}}}for(let a=0;a<i.length;a++){const r=i[a];c.has(r)||k(r)}return{ok:!0}}function B(n){typeof requestAnimationFrame=="function"?requestAnimationFrame(n):setTimeout(n,16)}function R(n){const t=l;if(!t){l=n;try{window.__DARS_VDOM__=n}catch{}return}B(()=>{const e=x(t,n);if(!e.ok){console.warn("[Dars] Structural change detected (",e.reason,"), reloading...");try{location.reload()}catch{}return}l=n;try{window.__DARS_VDOM__=n}catch{}})}function T(n){l=n;try{window.__DARS_VDOM__=n}catch{}["click","dblclick","mousedown","mouseup","mouseenter","mouseleave","mousemove","keydown","keyup","keypress","change","input","submit","focus","blur"].forEach(e=>A(e,document))}function E(){try{if(window.__DARS_HOTRELOAD_DISABLED__)return()=>{}}catch{}const n=window.__DARS_VERSION_URL||"version.txt";let t=null,e=!1,o=0;const i=10;let m=!1;function y(a,r,h,b){try{const s=new XMLHttpRequest;b&&(s.responseType=b),s.open("GET",a,!0),s.timeout=5e3,s.onreadystatechange=function(){s.readyState===4&&(s.status>=200&&s.status<300?r(s.response):h())},s.onerror=h,s.ontimeout=h,s.setRequestHeader("Cache-Control","no-store"),s.send()}catch{h()}}function c(){m||y(n,function(a){let r=(a||"").toString().trim();if(!r||r==="0"){if(o+=1,o>=i){console.warn("[Dars] version file not found after",i,"attempts. Hot reload disabled for this session."),m=!0;try{window.__DARS_HOTRELOAD_DISABLED__=!0,window.__DARS_STOP_HOTRELOAD=null}catch{}if(t)try{clearTimeout(t)}catch{}return}e||(console.warn("[Dars] waiting for version file..."),e=!0),t=setTimeout(c,600);return}if(o=0,e=!1,p||(p=r),r&&r!==p){p=r;try{location.reload()}catch{}return}t=setTimeout(c,600)},function(){if(o+=1,o>=i){console.warn("[Dars] version file not reachable after",i,"attempts. Hot reload disabled for this session."),m=!0;try{window.__DARS_HOTRELOAD_DISABLED__=!0,window.__DARS_STOP_HOTRELOAD=null}catch{}if(t)try{clearTimeout(t)}catch{}return}e||(console.warn("[Dars] waiting for version file..."),e=!0),t=setTimeout(c,600)},"text")}return c(),()=>{try{m=!0,t&&clearTimeout(t),window.__DARS_STOP_HOTRELOAD=null}catch{}}}function C(){if(window.__ROUTE_VDOM__?T(window.__ROUTE_VDOM__):window.__DARS_VDOM__&&T(window.__DARS_VDOM__),window.__DARS_VERSION_URL&&window.__DARS_SNAPSHOT_URL){try{typeof window.__DARS_STOP_HOTRELOAD=="function"&&window.__DARS_STOP_HOTRELOAD()}catch{}try{window.__DARS_STOP_HOTRELOAD=E()}catch{}}window.__ROUTE_VDOM__,window.__ROUTE_VDOM__}document.readyState==="complete"||document.readyState==="interactive"?C():document.addEventListener("DOMContentLoaded",C)})();window.addEventListener("scroll",()=>{const d=document.getElementById("dars-navbar");window.scrollY>20?d.classList.add("scrolled"):d.classList.remove("scrolled");const l=document.getElementById("features-section");if(l&&!l.classList.contains("visible")){const p=l.getBoundingClientRect().top,u=window.innerHeight/1.5;p<u&&(l.classList.add("visible"),document.querySelectorAll('[id^="feature-card-"]').forEach((_,S)=>{setTimeout(()=>{_.style.opacity="1",_.style.transform="translateY(0)"},S*100)}))}});document.addEventListener("DOMContentLoaded",function(){const d=document.getElementById("hamburger-btn"),l=document.getElementById("mobile-menu"),p=document.body;d&&l&&(d.addEventListener("click",function(u){u.stopPropagation(),l.style.display==="flex"?(l.style.display="none",d.classList.remove("menu-open"),p.classList.remove("menu-open")):(l.style.display="flex",d.classList.add("menu-open"),p.classList.add("menu-open"))}),l.querySelectorAll("a").forEach(u=>{u.addEventListener("click",function(){l.style.display="none",d.classList.remove("menu-open"),p.classList.remove("menu-open")})}),document.addEventListener("click",function(u){!d.contains(u.target)&&!l.contains(u.target)&&(l.style.display="none",d.classList.remove("menu-open"),p.classList.remove("menu-open"))}),document.addEventListener("keydown",function(u){u.key==="Escape"&&l.style.display==="flex"&&(l.style.display="none",d.classList.remove("menu-open"),p.classList.remove("menu-open"))}))});})();
